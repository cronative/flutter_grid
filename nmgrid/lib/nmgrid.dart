...
class NMGrid extends StatefulWidget {
  ...
  NMGrid(
      ...
      required this.notifySearchOnlyIf,
      ...
      required this.paginationDynamicStyle,
      required this.headerAlignmentByCells,
      required this.alignmentByRow,
      required this.data,
      required this.dataAsync,
      required this.headerCellRenderer,
      required this.headerCellsColor,
      required this.heightByRow,
      required this.noContentWidget,
      required this.onSearch,
      this.searchFieldAutoFocus = false,
      required this.onPaginationItemClick,
    ...
    List<Widget> cellWidgets = List.generate(
      ...
      (i) {
        ...
        return Expanded(
            ...
            child: Container(
              decoration: BoxDecoration(
                  color: widget.applyZebraEffect && zebra
                      ? HexColor("#F9fafb")
                      : null,
